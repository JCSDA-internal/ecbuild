      ...
      if( HAVE_SHARED_LIBS AND NOT ECBUILD_DISABLE_RPATH_FIX )
        ...
        if( NOT ${_linker_understands_origin} )
          ...
          if( (NOT CMAKE_Fortran_COMPILER_ID MATCHES Intel OR CMAKE_Fortran_COMPILER_VERSION VERSION_GREATER 18) AND
            ...
            set( ECBUILD_DISABLE_NEW_DTAGS OFF CACHE STRING "Disabled ecbuild feature (OFF=disabled)" FORCE)
            set( ECBUILD_DISABLE_RPATH_FIX ON CACHE STRING "Disabled ecbuild feature (ON=disabled)" FORCE)
          endif()
        endif()
        cmake_policy( POP )
      endif()
